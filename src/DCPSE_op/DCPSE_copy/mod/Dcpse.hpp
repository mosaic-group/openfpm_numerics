//
// Created by tommaso,Pietro on 09/01/20.
//
...
private:
    ...
    openfpm::vector<EMatrix<T, Eigen::Dynamic, 1>> A_parts;
    ...
    void solve_coeff(DCPSE_options opt)
    {
        ...
        monomialBasis(differentialSignature.asArray(), convergenceOrder)
{
    ...
    {
        initializeAdaptive(particles, convergenceOrder, rCut,opt);
    } else
    {
        initializeStaticSize(particles, convergenceOrder, rCut, supportSizeFactor,opt);
    }
}
